...
export const editReel=(data)=>async(dispatch)=>{
  const res = await fetch(`${BASE_URL}/api/reels/edit`,{
      method:"PUT",
      headers:{
          "Content-Type":"application/json",
          Authorization:'Bearer '+data.jwt,
  ...
  console.log("updated reel =----------------- ",resData)
  dispatch({type:EDIT_REEL,payload:resData});
}
